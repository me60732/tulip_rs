...
mod tests {
    ...
    use tulip_rs::indicators::willr::{Indicator, IndicatorState, TIndicatorState, Willr};
    ...
    #[test]
    fn test_willr_state_bincode_roundtrip() {
        // Generate 600-bar local series (min_data=14, enough for state)
