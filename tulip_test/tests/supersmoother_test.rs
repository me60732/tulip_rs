...
mod tests {
    ...
    use tulip_rs::indicators::supersmoother::{
        Indicator, IndicatorByOptions, IndicatorState, SuperSmoother, TIndicatorState, INPUTS,
    };
    ...
    #[test]
    fn test_supersmoother_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = SuperSmoother::indicator(&first, &options, None).unwrap();
