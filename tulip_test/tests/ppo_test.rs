...
mod tests {
    ...
    use tulip_rs::indicators::ppo::{Indicator, IndicatorByOptions, Ppo, TIndicatorState, IndicatorState, INPUTS, OPTIONS};
    ...
    fn test_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = Ppo::indicator(&first, &options, None).unwrap();
        let cfg = standard();
