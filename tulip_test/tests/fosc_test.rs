...
mod tests {
    ...
    use tulip_rs::indicators::fosc::{Fosc, Indicator, TIndicatorState, IndicatorState, INPUTS, OPTIONS};
    ...
    fn test_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = Fosc::indicator(&first, &options, None).unwrap();
        let cfg = standard();
