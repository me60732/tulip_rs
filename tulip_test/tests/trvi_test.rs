...
mod tests {
    ...
    use tulip_rs::indicators::trvi::{
        Indicator, IndicatorByOptions, IndicatorState, TIndicatorState, Trvi, INPUTS,
    };
    ...
    #[test]
    fn test_trvi_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = Trvi::indicator(&first, &options, None).unwrap();
