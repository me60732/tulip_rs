...
mod tests {
    ...
    use tulip_rs::indicators::vwma::{Indicator, IndicatorState, TIndicatorState, Vwma};
    ...
    #[test]
    fn test_vwma_state_bincode_roundtrip() {
        // Generate 600-bar local series (min_data=14 for vwma, enough for state)
