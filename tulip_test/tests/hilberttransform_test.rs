...
mod tests {
    ...
    fn test_hilberttransform_state_bincode_roundtrip() {
        ...
        let a = original
            .batch_indicator(&second, Some(&[true, true]))
            .unwrap();
        let b = restored
            .batch_indicator(&second, Some(&[true, true]))
            .unwrap();
