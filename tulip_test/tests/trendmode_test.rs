...
mod tests {
    ...
    use tulip_rs::indicators::trendmode::{
        Indicator, IndicatorByOptions, IndicatorState, TrendMode, INPUTS,
    };
    ...
    #[test]
    fn test_trendmode_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = TrendMode::indicator(&first, &options, None).unwrap();
