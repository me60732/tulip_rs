...
mod tests {
    ...
    use tulip_rs::indicators::ultosc::{Indicator, IndicatorState, TIndicatorState, Ultosc};
    ...
    #[test]
    fn test_ultosc_state_bincode_roundtrip() {
        ...
        // ultosc OPTIONS_LIST[0] = [7.0,14.0,28.0]
