...
mod tests {
    ...
    use tulip_rs::indicators::{
        typprice::Typprice,
        vwap::{Indicator, IndicatorState, TIndicatorState, Vwap},
    };
    ...
    #[test]
    fn test_vwap_state_bincode_roundtrip() {
        // Generate 600-bar local series (min_data=Typprice::min_data(), enough for state)
