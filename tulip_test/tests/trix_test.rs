...
mod tests {
    ...
    use tulip_rs::indicators::trix::{Indicator, IndicatorByOptions, TIndicatorState, Trix, OPTIONS, INPUTS, IndicatorState};
    ...
    fn test_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = Trix::indicator(&first, &options, None).unwrap();
        let cfg = standard();
