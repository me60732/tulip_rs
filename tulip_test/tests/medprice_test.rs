...
mod tests {
    ...
    use tulip_rs::indicators::medprice::{Indicator, IndicatorState, Medprice, INPUTS, OPTIONS};
    ...
    #[test]
    fn test_medprice_state_bincode_roundtrip() {
        ...
        let (_rows, mut original) = Medprice::indicator(&first, &options, None).unwrap();
