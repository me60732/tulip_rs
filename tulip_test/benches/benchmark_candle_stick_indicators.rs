...
fn get_all_forecast_variants() -> Vec<(String, Option<ForecastType>)> {
    vec![
        (
            "BearishReversal".to_string(),
            Some(ForecastType::BearishReversal),
        ),
        (
            "BullishReversal".to_string(),
            Some(ForecastType::BullishReversal),
        ),
        (
            "BearishContinuation".to_string(),
            Some(ForecastType::BearishContinuation),
        ),
        (
            "BullishContinuation".to_string(),
            Some(ForecastType::BullishContinuation),
        ),
        (
        ...
        (
            ...
            Some(ForecastType::BullishReversalOrContinuation),
        ),
        ("None".to_string(), None),
    ]
}
