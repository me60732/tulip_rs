...
fn bench_rust_mass_simd_by_options(c: &mut Criterion) {
    ...
    if should_log_to_db() {
        ...
        for (stock_symbol, stock_data) in data {
            ...
            timing.measure(
                || {
                    ...
                    black_box(&result_8);
                    /*let result_4 =
                        tulip_rs::indicators::nightly::mass_simd::indicator_by_options::<4>(
                    ...
                    let result_2 =
                        tulip_rs::indicators::nightly::mass_simd::indicator_by_options::<2>(
        ...
        group.sample_size(SAMPLE_SIZE);
        group.bench_function("Rust SIMD MASS (4+2 lanes)", |b| {
            b.iter(|| {
