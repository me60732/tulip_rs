...
fn bench_rust_ao_simd_by_assets(c: &mut Criterion) {
    if should_log_to_db() {
        init_database_data();
        init_logging("ao");
        ...
        /*let inputs: [&[&[f64]; 2]; 8] = [
            ...
            &[&stock_data[2].1, &stock_data[2].2], // high, low
            &[&stock_data[3].1, &stock_data[3].2], // high, low
            &[&stock_data[4].1, &stock_data[4].2], // high, low
            &[&stock_data[5].1, &stock_data[5].2], // high, low
            &[&stock_data[6].1, &stock_data[6].2], // high, low
            &[&stock_data[7].1, &stock_data[7].2], // high, low
        ];*/
