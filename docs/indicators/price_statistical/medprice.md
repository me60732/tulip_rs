...
=== "Go"
    ...
    **By assets** — same period applied to 4 assets in parallel (lane counts 2/4/8/16):
    ...
    h3 := []float64{90.0 + 0.5*0 + 82.15*0.1, 90.0 + 0.5*1 + 81.89*0.1, 90.0 + 0.5*2 + 83.03*0.1, 90.0 + 0.5*3 + 83.30*0.1, 90.0 + 0.5*4 + 83.85*0.1, 90.0 + 0.5*5 + 83.90*0.1, 90.0 + 0.5*6 + 83.33*0.1, 90.0 + 0.5*7 + 84.30*0.1, 90.0 + 0.5*8 + 84.84*0.1, 90.0 + 0.5*9 + 85.00*0.1}
