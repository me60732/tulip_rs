...
=== "Go"
    ...
    **By assets** — same options applied to 4 assets in parallel (lane counts 2/4/8/16):
    ...
    ```go
    assets := [][indicators.AdxInputs][]float64{{a1_high, a1_low, a1_close}, {a2_high, a2_low, a2_close}, {a3_high, a3_low, a3_close}, {a4_high, a4_low, a4_close}}
    ...
    **By options** — same asset, 4 different periods in parallel:
    ...
    ```go
    sim2, _ := indicators.Adx.SimdByOptions(high, low, close, [][]float64{{7.0}, {14.0}, {21.0}, {28.0}}, nil)
