use crate::cdlcommon::{cdl_colour, cdl_height, cdl_real_in_body_position, cdl_real_within_body, determine_volatility, LONG, RED, SHORT};
...
pub fn info() -> CandleInfo {
    CandleInfo {
        ...
        bars: 3,
        japanese_name: "Sankawa yoi no myojyo",
...
pub fn calc(open: &[f64], high: &[f64], low: &[f64], close: &[f64], i: usize, options: &DojiOptions) -> i8 {
    ...
    } if let Some(marubozu_result) = CDLMarubozu::classify(open[third], high[third], low[third], close[third], options) {
