use crate::cdlcommon::{cdl_body_fill, cdl_colour, determine_volatility, FILL, HALLOW, GREEN, RED };
...
pub fn calc(open: &[f64], high: &[f64], low: &[f64], close: &[f64], i: usize, options: &DojiOptions) -> i8 {
    ...
    if high[third] >= low[second] { return 0 }
