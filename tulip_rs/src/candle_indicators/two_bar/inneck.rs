use crate::cdlcommon::{cdl_body_fill, cdl_colour, cdl_height, cdl_real_in_body_position, cdl_wick_length, determine_volatility, FILL, GREEN, HALLOW, SHORT, LONG};
