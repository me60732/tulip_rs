use crate::cdlcommon::{cdl_colour, cdl_height, cdl_real_in_body_position, determine_volatility, GREEN, SHORT};
...
use crate::candle_types::{DojiOptions, CDLBasic, CDLMarubozu};
...
pub fn calc(open: &[f64], high: &[f64], low: &[f64], close: &[f64], i: usize, options: &DojiOptions) -> i8 {
    ...
    if open[second] >= low[first] { return 0 }
