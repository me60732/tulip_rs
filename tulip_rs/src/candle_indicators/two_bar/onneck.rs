use crate::cdlcommon::{cdl_body_fill, cdl_colour, cdl_height, cdl_wick_length, determine_volatility, FILL, GREEN, HALLOW, SHORT, LONG};
...
pub fn calc(open: &[f64], high: &[f64], low: &[f64], close: &[f64], i: usize, options: &DojiOptions) -> i8 {
    ...
    if close[second] != low[first] { return 0 }
