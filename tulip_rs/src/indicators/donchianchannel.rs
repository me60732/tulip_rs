...
/// Computes one step of the Donchian Channel indicator.
///
/// Advances the rolling min and max states by one bar and returns the lower, middle,
/// and upper channel values.
///
/// # Arguments
///
/// * `state` - Mutable reference to the current min/max state.
