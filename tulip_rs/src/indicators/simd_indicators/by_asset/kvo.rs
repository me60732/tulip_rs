...
use crate::indicators::{
    ema::Ema,
    kvo::{
        Kvo, Indicator, validate_options, IndicatorState, State, INPUTS,
        OPTIONS,
    },
};
...
pub(crate) fn indicator_by_assets<const N: usize>(
    ...
    validate_inputs::<INPUTS>(inputs, Kvo::min_data(options))?;
    ...
    for i in 0..N {
        ...
        let capacity = Kvo::output_length(len, options);
