...
use crate::indicators::{
    natr::{Natr, Indicator, IndicatorState, State, INPUTS, OPTIONS},
    tr::Tr
};
...
pub fn indicator_by_assets<const N: usize>(
    ...
    validate_inputs::<INPUTS>(inputs, Natr::min_data(options))?;
    ...
    for i in 0..N {
        ...
        let capacity = Natr::output_length(inputs[i][0].len(), options);
