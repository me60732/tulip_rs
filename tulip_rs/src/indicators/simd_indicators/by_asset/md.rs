...
use crate::indicators::md::{Md, Indicator, IndicatorState, INPUTS, OPTIONS, State};
use crate::indicators::simd_indicators::road_train::{Asset, Driver, PrimeMover};
use crate::indicators::simd_indicators::md_simd::{assets::SimdState, TSimdState, TState};
...
impl Driver<State<Warm>> for MdDriver {
...
pub fn indicator_by_assets<const N: usize>(
    ...
    validate_inputs::<INPUTS>(inputs, Md::min_data(options))?;
    ...
    for i in 0..N {
        ...
        let (md_line, sma_line) = {
            let capacity = Md::output_length(inputs[i][0].len(), options);
            (
