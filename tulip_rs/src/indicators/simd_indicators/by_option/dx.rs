...
use crate::indicators::dx::{Dx, Indicator, IndicatorState, State, INPUTS, OPTIONS};
use crate::indicators::simd_indicators::dx_simd::{SimdState, TSimdState, TState};
...
impl Driver<State<Warm>> for DxDriver {
    ...
    fn next_run<const N: usize>(
        ...
        for i in 0..len {
            ...
            let (dx, atr, tr) = state.calc(inputs);
...
pub fn indicator_by_options<const N: usize>(
    ...
    validate_inputs::<OPTIONS>(inputs, options, Dx::min_data)?;
    ...
    for i in 0..N {
        ...
        let (dx_line, atr_line, mut tr_line);
        {
            ...
            let capacity = Dx::output_length(len, options[i]);
