use tulip_rs::candle_indicators::bullishtasukiline::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish tasuki line pattern
    let pattern_open = vec![87.10, 86.20];
    let pattern_high = vec![87.15, 87.30];
    let pattern_low = vec![86.0, 86.10];
    let pattern_close = vec![86.10, 87.20];

    /////////////////////////////////////////////////// Calculating the Full Bullish Tasuki Line Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Tasuki Line Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Tasuki Line Pattern from state
    ...
    // Extend with pattern data to create bullish tasuki line
