use tulip_rs::candle_indicators::invertedhammer::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates an inverted hammer pattern
    let pattern_open = vec![87.30, 86.00];
    let pattern_high = vec![87.50, 87.60];
    let pattern_low = vec![86.20, 86.0];
    let pattern_close = vec![86.30, 86.40];

    /////////////////////////////////////////////////// Calculating the Full Inverted Hammer Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Inverted Hammer Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Inverted Hammer Pattern from state
    ...
    // Extend with pattern data to create inverted hammer
