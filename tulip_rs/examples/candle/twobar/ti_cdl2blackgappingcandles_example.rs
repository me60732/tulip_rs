use tulip_rs::candle_indicators::twoblackgappingcandles::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a two black gapping candles pattern
    let pattern_open = vec![86.30, 85.20];
    let pattern_high = vec![86.40, 85.55];
    let pattern_low = vec![85.0, 84.70];
    let pattern_close = vec![85.30, 84.80];

    /////////////////////////////////////////////////// Calculating the Full Two Black Gapping Candles Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Two Black Gapping Candles Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Two Black Gapping Candles Pattern from state
    ...
    // Extend with pattern data to create two black gapping candles
