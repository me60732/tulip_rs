use tulip_rs::candle_indicators::onneck::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates an on neck pattern
    let pattern_open = vec![87.30, 86.00];
    let pattern_high = vec![87.50, 86.50];
    let pattern_low = vec![86.20, 86.10];
    let pattern_close = vec![86.30, 86.20];

    /////////////////////////////////////////////////// Calculating the Full On Neck Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial On Neck Pattern
    ...
    /////////////////////////////////////////////////// Calculating the On Neck Pattern from state
    ...
    // Extend with pattern data to create on neck
