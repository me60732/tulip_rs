use tulip_rs::candle_indicators::turnup::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_high = vec![86.00, 87.55];
    let pattern_low = vec![85.35, 87.20];
    let pattern_close = vec![85.40, 87.50];
