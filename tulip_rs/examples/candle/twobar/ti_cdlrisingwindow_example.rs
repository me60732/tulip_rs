...
fn main() {
    ...
    let pattern_open = vec![87.80, 87.90];
    let pattern_high = vec![87.70, 88.50];
    let pattern_low = vec![87.00, 87.80];
    let pattern_close = vec![87.40, 88.30];
