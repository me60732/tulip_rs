use tulip_rs::candle_indicators::risingwindow::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a rising window pattern
    let pattern_open = vec![85.80, 87.30];
    let pattern_high = vec![86.00, 87.50];
    let pattern_low = vec![86.00, 86.20];
    let pattern_close = vec![85.40, 86.30];

    /////////////////////////////////////////////////// Calculating the Full Rising Window Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Rising Window Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Rising Window Pattern from state
    ...
    // Extend with pattern data to create rising window
