use tulip_rs::candle_indicators::bullishdojistar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish doji star pattern
    let pattern_open = vec![87.30, 85.50];
    let pattern_high = vec![87.50, 86.0];
    let pattern_low = vec![86.25, 85.30];
    let pattern_close = vec![86.30, 85.50];

    /////////////////////////////////////////////////// Calculating the Full Bullish Doji Star Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Doji Star Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Doji Star Pattern from state
    ...
    // Extend with pattern data to create bullish doji star
