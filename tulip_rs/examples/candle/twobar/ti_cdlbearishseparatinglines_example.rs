use tulip_rs::candle_indicators::bearishseparatinglines::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish separating lines pattern
    let pattern_open = vec![86.30, 86.30];
    let pattern_high = vec![88.0, 86.55];
    let pattern_low = vec![86.0, 85.10];
    let pattern_close = vec![87.25, 85.30];

    /////////////////////////////////////////////////// Calculating the Full Bearish Separating Lines Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Separating Lines Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Separating Lines Pattern from state
    ...
    // Extend with pattern data to create bearish separating lines
