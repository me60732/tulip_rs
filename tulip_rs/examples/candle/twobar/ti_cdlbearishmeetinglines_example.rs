use tulip_rs::candle_indicators::bearishmeetinglines::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish meeting lines pattern
    let pattern_open = vec![87.30, 89.00];
    let pattern_high = vec![88.50, 89.10];
    let pattern_low = vec![87.20, 88.10];
    let pattern_close = vec![88.30, 88.30];

    /////////////////////////////////////////////////// Calculating the Full Bearish Meeting Lines Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Meeting Lines Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Meeting Lines Pattern from state
    ...
    // Extend with pattern data to create bearish meeting lines
