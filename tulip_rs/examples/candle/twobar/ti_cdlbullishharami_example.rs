use tulip_rs::candle_indicators::bullishharami::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish harami pattern
    let pattern_open = vec![87.30, 86.40];
    let pattern_high = vec![88.0, 86.55];
    let pattern_low = vec![86.0, 86.45];
    let pattern_close = vec![86.30, 86.50];

    /////////////////////////////////////////////////// Calculating the Full Bullish Harami Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Harami Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Harami Pattern from state
    ...
    // Extend with pattern data to create bullish harami
