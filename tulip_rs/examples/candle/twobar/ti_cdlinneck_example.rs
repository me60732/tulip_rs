use tulip_rs::candle_indicators::inneck::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates an in neck pattern
    let pattern_open = vec![87.30, 86.00];
    let pattern_high = vec![87.50, 86.50];
    let pattern_low = vec![86.20, 86.30];
    let pattern_close = vec![86.30, 86.40];

    /////////////////////////////////////////////////// Calculating the Full In Neck Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial In Neck Pattern
    ...
    /////////////////////////////////////////////////// Calculating the In Neck Pattern from state
    ...
    // Extend with pattern data to create in neck
