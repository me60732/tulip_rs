use tulip_rs::candle_indicators::homingpigeon::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a homing pigeon pattern
    let pattern_open = vec![87.30, 86.50];
    let pattern_high = vec![88.0, 86.55];
    let pattern_low = vec![86.0, 86.35];
    let pattern_close = vec![86.30, 86.40];

    /////////////////////////////////////////////////// Calculating the Full Homing Pigeon Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Homing Pigeon Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Homing Pigeon Pattern from state
    ...
    // Extend with pattern data to create homing pigeon
