...
fn main() {
    ...
    let mut open = vec![
        ...
        88.00, 87.30, 87.15, 86.90, 86.15,
    ];
    let mut high = vec![
        82.15, 81.89, 83.03, 83.30, 83.85, 83.90, 83.33, 84.30, 84.84, 85.00, 85.90, 86.58, 86.98,
        88.00, 87.31, 87.30, 87.0, 86.50,
    ];
    let mut low = vec![
        81.29, 80.64, 81.31, 82.65, 83.07, 83.11, 82.49, 82.30, 84.15, 84.11, 84.03, 85.39, 85.76,
        87.17, 87.20, 87.0, 86.80, 86.20,
    ];
    let mut close = vec![
        81.59, 81.06, 82.87, 83.00, 83.61, 83.15, 82.84, 83.99, 84.55, 84.36, 85.53, 86.54, 86.89,
        87.77, 87.21, 87.05, 86.90, 86.30,
    ];

    let pattern_open = vec![85.30, 84.05];
    let pattern_high = vec![85.50, 84.05];
    let pattern_low = vec![84.10, 83.80];
    let pattern_close = vec![84.15, 83.90];
