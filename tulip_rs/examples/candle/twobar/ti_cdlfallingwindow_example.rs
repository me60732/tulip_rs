use tulip_rs::candle_indicators::fallingwindow::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a falling window pattern
    let pattern_open = vec![87.30, 85.80];
    let pattern_high = vec![87.50, 86.00];
    let pattern_low = vec![86.20, 85.30];
    let pattern_close = vec![86.30, 85.40];

    /////////////////////////////////////////////////// Calculating the Full Falling Window Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Falling Window Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Falling Window Pattern from state
    ...
    // Extend with pattern data to create falling window
