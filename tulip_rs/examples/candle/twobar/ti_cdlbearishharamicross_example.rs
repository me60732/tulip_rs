use tulip_rs::candle_indicators::bearishharamicross::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish harami cross pattern
    ...
    /////////////////////////////////////////////////// Calculating the Full Bearish Harami Cross Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Harami Cross Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Harami Cross Pattern from state
    ...
    // Extend with pattern data to create bearish harami cross
