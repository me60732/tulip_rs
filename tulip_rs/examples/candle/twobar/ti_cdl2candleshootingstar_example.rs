use tulip_rs::candle_indicators::twocandleshootingstar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a two candle shooting star pattern
    let pattern_open = vec![87.30, 88.35];
    let pattern_high = vec![88.50, 89.80];
    let pattern_low = vec![87.20, 88.35];
    let pattern_close = vec![88.30, 88.65];

    /////////////////////////////////////////////////// Calculating the Full Two Candle Shooting Star Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Two Candle Shooting Star Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Two Candle Shooting Star Pattern from state
    ...
    // Extend with pattern data to create two candle shooting star
