use tulip_rs::candle_indicators::matchinghigh::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a matching high pattern
    let pattern_open = vec![87.20, 87.50];
    let pattern_high = vec![88.0, 88.0];
    let pattern_low = vec![87.0, 87.20];
    let pattern_close = vec![88.00, 88.0];

    /////////////////////////////////////////////////// Calculating the Full Matching High Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Matching High Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Matching High Pattern from state
    ...
    // Extend with pattern data to create matching high
