use tulip_rs::candle_indicators::bullishseparatinglines::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish separating lines pattern
    let pattern_open = vec![88.30, 88.30];
    let pattern_high = vec![88.50, 89.10];
    let pattern_low = vec![87.20, 88.10];
    let pattern_close = vec![87.30, 89.0];

    /////////////////////////////////////////////////// Calculating the Full Bullish Separating Lines Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Separating Lines Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Separating Lines Pattern from state
    ...
    // Extend with pattern data to create bullish separating lines
