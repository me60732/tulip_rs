use tulip_rs::candle_indicators::bullishengulfing::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish engulfing pattern
    let pattern_open = vec![88.30, 86.20];
    let pattern_high = vec![88.40, 89.60];
    let pattern_low = vec![87.27, 86.10];
    let pattern_close = vec![87.28, 89.50];

    /////////////////////////////////////////////////// Calculating the Full Bullish Engulfing Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Engulfing Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Engulfing Pattern from state
    ...
    // Extend with pattern data to create bullish engulfing
