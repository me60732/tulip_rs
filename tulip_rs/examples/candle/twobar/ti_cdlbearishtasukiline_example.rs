use tulip_rs::candle_indicators::bearishtasukiline::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish tasuki line pattern
    let pattern_open = vec![87.30, 88.20];
    let pattern_high = vec![88.50, 88.30];
    let pattern_low = vec![87.20, 87.10];
    let pattern_close = vec![88.30, 87.20];

    /////////////////////////////////////////////////// Calculating the Full Bearish Tasuki Line Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Tasuki Line Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Tasuki Line Pattern from state
    ...
    // Extend with pattern data to create bearish tasuki line
