use tulip_rs::candle_indicators::descendinghawk::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a descending hawk pattern
    let pattern_open = vec![87.30, 87.40];
    let pattern_high = vec![88.50, 88.10];
    let pattern_low = vec![87.20, 87.30];
    let pattern_close = vec![88.30, 88.00];

    /////////////////////////////////////////////////// Calculating the Full Descending Hawk Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Descending Hawk Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Descending Hawk Pattern from state
    ...
    // Extend with pattern data to create descending hawk
