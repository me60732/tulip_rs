use tulip_rs::candle_indicators::bullishharamicross::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish harami cross pattern
    let pattern_open = vec![87.30, 86.50];
    let pattern_high = vec![88.0, 86.65];
    let pattern_low = vec![86.0, 86.40];
    let pattern_close = vec![86.30, 86.50];

    /////////////////////////////////////////////////// Calculating the Full Bullish Harami Cross Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Harami Cross Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Harami Cross Pattern from state
    ...
    // Extend with pattern data to create bullish harami cross
