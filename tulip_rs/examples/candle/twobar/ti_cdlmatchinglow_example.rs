use tulip_rs::candle_indicators::matchinglow::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a matching low pattern
    let pattern_open = vec![87.20, 87.0];
    let pattern_high = vec![87.30, 87.20];
    let pattern_low = vec![86.0, 86.0];
    let pattern_close = vec![86.0, 86.0];

    /////////////////////////////////////////////////// Calculating the Full Matching Low Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Matching Low Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Matching Low Pattern from state
    ...
    // Extend with pattern data to create matching low
