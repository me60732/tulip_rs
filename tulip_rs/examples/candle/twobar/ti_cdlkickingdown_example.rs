use tulip_rs::candle_indicators::kickingdown::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a kicking down pattern
    let pattern_open = vec![86.20, 86.19];
    let pattern_high = vec![87.30, 86.19];
    let pattern_low = vec![86.20, 85.20];
    let pattern_close = vec![87.30, 85.20];

    /////////////////////////////////////////////////// Calculating the Full Kicking Down Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Kicking Down Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Kicking Down Pattern from state
    ...
    // Extend with pattern data to create kicking down
