use tulip_rs::candle_indicators::piercing::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a piercing pattern
    let pattern_open = vec![87.20, 86.15];
    let pattern_high = vec![87.25, 87.20];
    let pattern_low = vec![86.15, 86.10];
    let pattern_close = vec![86.20, 87.15];

    /////////////////////////////////////////////////// Calculating the Full Piercing Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Piercing Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Piercing Pattern from state
    ...
    // Extend with pattern data to create piercing
