use tulip_rs::candle_indicators::bearishharami::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish harami pattern
    let pattern_open = vec![87.30, 88.00];
    let pattern_high = vec![88.50, 88.10];
    let pattern_low = vec![87.20, 87.30];
    let pattern_close = vec![88.30, 87.40];

    /////////////////////////////////////////////////// Calculating the Full Bearish Harami Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Harami Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Harami Pattern from state
    ...
    // Extend with pattern data to create bearish harami
