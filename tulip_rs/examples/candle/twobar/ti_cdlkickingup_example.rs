use tulip_rs::candle_indicators::kickingup::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a kicking up pattern
    let pattern_open = vec![86.19, 86.20];
    let pattern_high = vec![86.19, 87.30];
    let pattern_low = vec![85.20, 86.20];
    let pattern_close = vec![85.20, 87.30];

    /////////////////////////////////////////////////// Calculating the Full Kicking Up Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Kicking Up Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Kicking Up Pattern from state
    ...
    // Extend with pattern data to create kicking up
