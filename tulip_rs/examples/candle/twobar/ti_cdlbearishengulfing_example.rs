use tulip_rs::candle_indicators::bearishengulfing::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish engulfing pattern
    let pattern_open = vec![87.40, 88.50];
    let pattern_high = vec![88.10, 88.60];
    let pattern_low = vec![87.30, 87.10];
    let pattern_close = vec![88.00, 87.20];

    /////////////////////////////////////////////////// Calculating the Full Bearish Engulfing Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Engulfing Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Engulfing Pattern from state
    ...
    // Extend with pattern data to create bearish engulfing
