use tulip_rs::candle_indicators::bearishdojistar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish doji star pattern
    let pattern_open = vec![87.30, 88.50];
    let pattern_high = vec![88.50, 89.0];
    let pattern_low = vec![87.25, 88.30];
    let pattern_close = vec![88.30, 88.50];

    /////////////////////////////////////////////////// Calculating the Full Bearish Doji Star Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Doji Star Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Doji Star Pattern from state
    ...
    // Extend with pattern data to create bearish doji star
