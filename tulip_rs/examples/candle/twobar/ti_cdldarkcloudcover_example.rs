use tulip_rs::candle_indicators::darkcloudcover::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a dark cloud cover pattern
    let pattern_open = vec![87.30, 89.00];
    let pattern_high = vec![88.50, 89.10];
    let pattern_low = vec![87.20, 88.10];
    let pattern_close = vec![88.30, 87.35];

    /////////////////////////////////////////////////// Calculating the Full Dark Cloud Cover Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Dark Cloud Cover Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Dark Cloud Cover Pattern from state
    ...
    // Extend with pattern data to create dark cloud cover
