use tulip_rs::candle_indicators::bearishthreelinestrike::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish three line strike pattern
    let pattern_open = vec![87.30, 86.40, 85.40, 83.50];
    let pattern_high = vec![87.30, 86.40, 84.50, 87.95];
    let pattern_low = vec![86.30, 85.30, 83.0, 83.45];
    let pattern_close = vec![86.30, 85.30, 84.30, 87.90];

    /////////////////////////////////////////////////// Calculating the Full Bearish Three Line Strike Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Three Line Strike Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Three Line Strike Pattern from state
    ...
    // Extend with pattern data to create bearish three line strike
