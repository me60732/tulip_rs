use tulip_rs::candle_indicators::deliberation::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.30, 87.90, 88.80];
    let pattern_high = vec![88.35, 89.50, 89.20];
    let pattern_low = vec![87.25, 87.70, 88.75];
    let pattern_close = vec![88.30, 88.90, 89.0];
