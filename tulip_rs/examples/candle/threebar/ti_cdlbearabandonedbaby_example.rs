...
fn main() {
    ...
    let pattern_open = vec![87.15, 91.10, 89.70];
    let pattern_high = vec![90.0, 91.15, 89.97];
    let pattern_low = vec![87.10, 90.95, 88.20];
    let pattern_close = vec![89.50, 91.10, 88.20];
