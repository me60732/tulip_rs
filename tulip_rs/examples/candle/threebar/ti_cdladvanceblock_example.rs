use tulip_rs::candle_indicators::advanceblock::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.30, 87.90, 88.50];
    let pattern_high = vec![88.35, 89.50, 89.80];
    let pattern_low = vec![87.25, 87.70, 88.25];
    let pattern_close = vec![88.30, 88.51, 89.0];
