use tulip_rs::candle_indicators::threeinsideup::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.30, 86.40, 86.60];
    let pattern_high = vec![88.0, 86.55, 87.10];
    let pattern_low = vec![86.0, 86.45, 86.90];
    let pattern_close = vec![86.30, 86.50, 87.0];
