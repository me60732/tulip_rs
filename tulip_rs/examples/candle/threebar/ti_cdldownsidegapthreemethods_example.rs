...
fn main() {
    ...
    let pattern_open = vec![87.60, 86.35, 86.20];
    let pattern_high = vec![87.65, 86.40, 86.80];
    let pattern_low = vec![86.50, 85.10, 86.15];
    let pattern_close = vec![86.60, 85.35, 86.70];
