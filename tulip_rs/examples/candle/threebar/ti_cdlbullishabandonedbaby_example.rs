use tulip_rs::candle_indicators::bullabandonedbaby::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.15, 85.00, 86.60];
    let pattern_high = vec![87.20, 85.30, 87.20];
    let pattern_low = vec![86.45, 84.50, 86.50];
    let pattern_close = vec![86.50, 85.00, 87.0];
