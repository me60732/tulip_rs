...
fn main() {
    ...
    let pattern_open = vec![87.28, 86.90, 87.28];
    let pattern_high = vec![90.0, 87.30, 89.97];
    let pattern_low = vec![87.10, 86.80, 87.20];
    let pattern_close = vec![87.28, 86.90, 87.28];
