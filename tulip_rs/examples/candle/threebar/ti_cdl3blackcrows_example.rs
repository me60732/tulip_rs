use tulip_rs::candle_indicators::threeblackcrows::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a three black crows pattern
    let pattern_open = vec![87.50, 87.0, 86.50];
    let pattern_high = vec![87.55, 87.15, 86.60];
    let pattern_low = vec![86.10, 85.90, 85.20];
    let pattern_close = vec![86.50, 86.0, 85.50];

    /////////////////////////////////////////////////// Calculating the Full Three Black Crows Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Three Black Crows Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Three Black Crows Pattern from state
    ...
    // Extend with pattern data to create three black crows
