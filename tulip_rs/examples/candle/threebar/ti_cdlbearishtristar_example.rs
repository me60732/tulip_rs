...
fn main() {
    ...
    let pattern_open = vec![87.64, 90.10, 87.50];
    let pattern_high = vec![90.0, 90.15, 89.97];
    let pattern_low = vec![87.10, 89.95, 87.20];
    let pattern_close = vec![87.64, 90.10, 87.50];
