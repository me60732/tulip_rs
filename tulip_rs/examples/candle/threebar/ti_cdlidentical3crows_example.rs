use tulip_rs::candle_indicators::identicalthreecrows::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.50, 86.49, 85.52];
    let pattern_high = vec![87.55, 87.15, 85.60];
    let pattern_low = vec![86.10, 85.40, 84.20];
    let pattern_close = vec![86.50, 85.50, 84.50];
