use tulip_rs::candle_indicators::uniquethreeriverbottom::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.20, 87.00, 86.40];
    let pattern_high = vec![87.25, 87.10, 86.55];
    let pattern_low = vec![85.50, 85.25, 86.20];
    let pattern_close = vec![85.70, 86.50, 86.49];
