use tulip_rs::candle_indicators::eveningstar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.15, 90.0, 89.70];
    let pattern_high = vec![90.0, 90.15, 89.80];
    let pattern_low = vec![87.10, 89.95, 87.20];
    let pattern_close = vec![89.50, 90.10, 87.20];
