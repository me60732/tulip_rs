use tulip_rs::candle_indicators::eveningdojistar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    let pattern_open = vec![87.15, 90.10, 89.70];
    let pattern_high = vec![90.0, 90.15, 89.97];
    let pattern_low = vec![87.10, 89.95, 88.20];
    let pattern_close = vec![89.50, 90.10, 88.20];
