use tulip_rs::candle_indicators::bullsidebysidewhitelines::{
...
fn main() {
    ...
    let pattern_open = vec![87.20, 88.15, 88.13];
    let pattern_high = vec![88.05, 88.85, 88.84];
    let pattern_low = vec![87.15, 88.10, 88.11];
    let pattern_close = vec![88.00, 88.80, 88.82];
