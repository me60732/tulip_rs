use tulip_rs::candle_indicators::bearishstrongline::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bearish strongline pattern
    let pattern_open = vec![90.90];
    let pattern_high = vec![90.95];
    let pattern_low = vec![85.65];
    let pattern_close = vec![85.70];

    /////////////////////////////////////////////////// Calculating the Full Bearish Strongline Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bearish Strongline Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bearish Strongline Pattern from state
    ...
    // Extend with pattern data to create bearish strongline
