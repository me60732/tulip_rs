use tulip_rs::candle_indicators::northerndoji::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a northern doji pattern
    let pattern_open = vec![87.65];
    let pattern_high = vec![87.70];
    let pattern_low = vec![85.15];
    let pattern_close = vec![87.65];

    /////////////////////////////////////////////////// Calculating the Full Northern Doji Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Northern Doji Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Northern Doji Pattern from state
    ...
    // Extend with pattern data to create northern doji
