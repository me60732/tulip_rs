use tulip_rs::candle_indicators::gappingdowndoji::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a gapping down doji pattern
    let pattern_open = vec![86.50];
    let pattern_high = vec![86.50];
    let pattern_low = vec![85.25];
    let pattern_close = vec![86.50];

    /////////////////////////////////////////////////// Calculating the Full Gapping Down Doji Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Gapping Down Doji Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Gapping Down Doji Pattern from state
    ...
    // Extend with pattern data to create gapping down doji
