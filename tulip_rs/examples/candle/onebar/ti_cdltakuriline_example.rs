use tulip_rs::candle_indicators::takuriline::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a takuri line pattern
    let pattern_open = vec![86.90];
    let pattern_high = vec![87.0];
    let pattern_low = vec![85.65];
    let pattern_close = vec![86.60];

    /////////////////////////////////////////////////// Calculating the Full Takuri Line Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Takuri Line Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Takuri Line Pattern from state
    ...
    // Extend with pattern data to create takuri line
