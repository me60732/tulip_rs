use tulip_rs::candle_indicators::hammer::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    /////////////////////////////////////////////////// Calculating the partial Hammer Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Hammer Pattern from state
    ...
    // Extend with pattern data to create hammer
