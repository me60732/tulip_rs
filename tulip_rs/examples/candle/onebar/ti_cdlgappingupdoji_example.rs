use tulip_rs::candle_indicators::gappingupdoji::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a gapping up doji pattern
    let pattern_open = vec![88.50];
    let pattern_high = vec![88.50];
    let pattern_low = vec![88.25];
    let pattern_close = vec![88.50];

    /////////////////////////////////////////////////// Calculating the Full Gapping Up Doji Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Gapping Up Doji Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Gapping Up Doji Pattern from state
    ...
    // Extend with pattern data to create gapping up doji
