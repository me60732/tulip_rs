use tulip_rs::candle_indicators::southerndoji::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a southern doji pattern
    let pattern_open = vec![87.20];
    let pattern_high = vec![87.25];
    let pattern_low = vec![85.15];
    let pattern_close = vec![87.20];

    /////////////////////////////////////////////////// Calculating the Full Southern Doji Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Southern Doji Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Southern Doji Pattern from state
    ...
    // Extend with pattern data to create southern doji
