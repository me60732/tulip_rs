use tulip_rs::candle_indicators::hangingman::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a hanging man pattern
    let pattern_open = vec![87.35];
    let pattern_high = vec![87.35];
    let pattern_low = vec![85.15];
    let pattern_close = vec![87.30];

    /////////////////////////////////////////////////// Calculating the Full Hanging Man Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Hanging Man Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Hanging Man Pattern from state
    ...
    // Extend with pattern data to create hanging man
