use tulip_rs::candle_indicators::bullishbelthold::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a bullish belthold pattern
    let pattern_open = vec![85.75];
    let pattern_high = vec![87.49];
    let pattern_low = vec![85.75];
    let pattern_close = vec![87.25];

    /////////////////////////////////////////////////// Calculating the Full Bullish Belthold Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial Bullish Belthold Pattern
    ...
    /////////////////////////////////////////////////// Calculating the Bullish Belthold Pattern from state
    ...
    // Extend with pattern data to create bullish belthold
