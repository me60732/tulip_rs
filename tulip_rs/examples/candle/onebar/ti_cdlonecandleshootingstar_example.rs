use tulip_rs::candle_indicators::onecandleshootingstar::{indicator, indicator_from_state, info};
...
fn main() {
    ...
    // Pattern data that creates a one candle shooting star pattern
    let pattern_open = vec![87.40];
    let pattern_high = vec![88.90];
    let pattern_low = vec![87.25];
    let pattern_close = vec![87.30];

    /////////////////////////////////////////////////// Calculating the Full One Candle Shooting Star Pattern
    let inputs = [
        open.as_slice(),
        high.as_slice(),
        low.as_slice(),
    ...
    /////////////////////////////////////////////////// Calculating the partial One Candle Shooting Star Pattern
    ...
    /////////////////////////////////////////////////// Calculating the One Candle Shooting Star Pattern from state
    ...
    // Extend with pattern data to create one candle shooting star
